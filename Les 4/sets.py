...
alleen_in_1 = verzameling_kleuren_1 - verzameling_kleuren_2
niet_in_beide = {'red', 'yellow'} - (verzameling_kleuren_1 & verzameling_kleuren_2)

print()
print("Kleur(en) alleen in verzameling_kleuren_1:", alleen_in_1)
print("Kleuren niet in beide sets:", niet_in_beide)
