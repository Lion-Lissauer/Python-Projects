...
print(boodschappen.get('Appels', 'Niet gevonden'),boodschappen.get('Bananen', 'Niet gevonden'))
...
if boodschappenlijst_marie == boodschappenlijst_raj == boodschappenlijst_jan:
    print('De boodschappenlijstjes zijn gelijk omdat de sleutelwaarden overeenkomen.')
else:
    print('De boodschappenlijstjes zijn niet gelijk omdat de sleutelwaarden niet overeenkomen.')
...
cijfers2 = {student: min(cijfer * 1.5, 10) for student, cijfer in cijfers.items()}
print()
print(cijfers2)
...
dieren = {'Aap': 5, 'Zebra': 1, 'Leeuw': 3, 'Giraffe': 2, 'Olifant': 4}

dieren2 = dict(sorted(dieren.items()))
print()
print(dieren2)
aantallen = sorted(dieren.values(), reverse=True)
print(aantallen)
